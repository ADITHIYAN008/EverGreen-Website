...
const Discover = () => {
  return (
    <div className="text-secondary dark:text-primary lg:justify-between lg:px-15 px-3 py-5 md:flex md:gap-3 bg-secondary/5">
      <div className="flex justify-between w-full max-w-[1100px] mx-auto flex-col md:flex-row md:gap-10 xl:flex lg:flex-row">
        ...
        <div className="px-2">
          ...
          <p className="text-[10px] md:w-[300px] text-secondary/70 mt-2 dark:text-primary">
            From minimalist to compact solutions, small spaces inspire big
            ideas, proving that you don't need much room.
          </p>
          <Link
            to="/AllList"
            className="flex bg-secondary text-primary items-center text-[12px] px-8 py-3 rounded-3xl mt-5 mx-auto md:mx-0 w-[14rem] dark:bg-primary dark:text-secondary gap-2 cursor-pointer"
          >
